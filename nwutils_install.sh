...
#Usage
#curl -fsSL https://raw.githubusercontent.com/slashroot79/<repo>/main/nwutils_install.sh | bash

URL="https://raw.githubusercontent.com/slashroot79//main/nwutils.sh"
